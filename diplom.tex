...
\textbf{Доказательство.} Рассуждаем по аналогии с доказательством леммы 1.8. обозначим  , записываем представление (2.13) из леммы 2.5 в виде:

учитываем, что в выражении для  при  будут присутствовать степени , и тогда будет справедливо выражение:

Осталось найти конкретное выражение для
...
Сравнивая полученные выражения с соответствующими выражениями в лемме 1.8, видим, что они отличаются заменой  на ,  на , а также заменой знака на противоположный при вычислении  при - нечётном.

С учётом этого повторяем дословно дальнейшие рассуждения в доказательстве леммы 1.8 и приходим к утверждению леммы 2.8.
